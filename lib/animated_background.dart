  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedBuilder(
      ...
      builder: (context, child) {
        ...
        final Color interpolatedColor1 = Color.lerp(startColor, endColor, fraction)!;

        final double colorIndex2 = (value + 0.3) % 1 * (colors.length - 1); // Offset for the second color
        ...
        final Color interpolatedColor2 = Color.lerp(startColor2, endColor2, fraction2)!;
